...
export default function Home() {
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-4 py-14 sm:py-24 text-center">
      <div className="mb-6">
      ...
      <h1 className="text-3xl sm:text-5xl font-bold tracking-tight mb-5 sm:mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
        {[
          ...
          <div key={item.step} className="border border-border rounded-lg p-5 sm:p-6">
